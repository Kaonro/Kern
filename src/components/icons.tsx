...
/** Logo "G" Google multicolore — seule icône du fichier à ne pas suivre le style maison
 * (traits fins monochromes) : les règles de marque de Google imposent leur logo officiel
 * sur les boutons "Se connecter avec Google". */
export function IconGoogle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" width="1.2em" height="1.2em" className="icon" aria-hidden="true" {...props}>
      <path
        fill="#4285F4"
      ...
      />
      <path fill="#FBBC05" d="M11.69 28.18C11.25 26.86 11 25.45 11 24s.25-2.86.69-4.18v-5.7H4.34A21.93 21.93 0 0 0 2 24c0 3.55.85 6.91 2.34 9.88z" />
      <path
        fill="#EA4335"
